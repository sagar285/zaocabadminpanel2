...
import {  useUploadPoliceVerificationLicenseMutation } from '../../Redux/Api';

const AddPoliceVerificationDocumentModal = ({ isOpen, onClose, docType, userId,refetch }) => {
  const [formData, setFormData] = useState({
    frontImage: null,
    backImage: null,
    number: ''
  });
  const [uploadPoliceVerification] =useUploadPoliceVerificationLicenseMutation();
  ...
  const handleSubmit = async(e) => {
    ...
    if (formData.frontImage) data.append('police_certificate', formData.frontImage);
    data.append("userId",userId);
    data.append("isAdmin",true);
    const response = await uploadPoliceVerification(data);
...
export default AddPoliceVerificationDocumentModal;