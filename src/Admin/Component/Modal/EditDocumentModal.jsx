...
import { useUploadAadharCardMutation } from '../../Redux/Api';

const EditDocumentModal = ({ isOpen, onClose, docType, userId,refetch }) => {
  ...
  const handleSubmit = async(e) => {
    ...
    if (formData.frontImage) data.append('aadhar_front', formData.frontImage);
    if (formData.backImage) data.append('aadhar_back', formData.backImage);
    if (formData.number) data.append('aadharNumber', formData.number);
    data.append("userId",userId);
    data.append("isAdmin",true);
    const response = await uploadAadhar(data);
